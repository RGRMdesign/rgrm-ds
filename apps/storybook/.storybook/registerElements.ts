import {
  RGRM_BUTTON_TAG,
  RgrmButtonElement,
} from '@rgrmdesign/rgrm-ds-elements/button';
import {
  RGRM_HEADING_TAG,
  RgrmHeadingElement,
} from '@rgrmdesign/rgrm-ds-elements/heading';
import {
  RGRM_PARAGRAPH_TAG,
  RgrmParagraphElement,
} from '@rgrmdesign/rgrm-ds-elements/paragraph';
import {
  RGRM_ROOT_TAG,
  RgrmRootElement,
} from '@rgrmdesign/rgrm-ds-elements/root';
import {
  RGRM_SECTION_TAG,
  RgrmSectionElement,
} from '@rgrmdesign/rgrm-ds-elements/section';
